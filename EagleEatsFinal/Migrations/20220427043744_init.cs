    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Review_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Reviewed_User_Id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayMethods", x => x.Method_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryRoutes", x => x.Route_Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryRoutes_Items_Item_Id",
                        column: x => x.Item_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Deliveries_DeliveryRoutes_Route_Id",
                        column: x => x.Route_Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoutes_Item_Id",
                table: "DeliveryRoutes",
                column: "Item_Id");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryRoutes_ReceiverId",
                table: "DeliveryRoutes",
                column: "ReceiverId");
